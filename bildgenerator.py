...
class Bildgenerator:
    ...
    def concatenate_second_img(self, img1, form_pool, color_pool):
        ...
        img2 = self.colorize_img(img2, choice(color_pool)) #Faerbt das Bild random mit einer der uebrig gebliebenden Farben
    ...
    def set_target1(self):
        ...
        target = self.colorize_img(target,self.position) #Da der Farbcode der gleiche der Form der Optionsbilder ist
    ...
    def rotate_img(img):
        ...
        cv.imwrite("Bilder/test.jpg", img)
        img = ((255,255,255)-img)
        return img
